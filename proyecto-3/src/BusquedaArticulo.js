...
class BusquedaArticulo extends Component {
    ...
    render() {
        ...
        return (
            <div className='BusquedaArticulo'><Navbar collapseOnSelect expand="lg" bg="dark" variant="dark" className='m-auto'>
                ...
                <Container>
                    <Row>
                        <Col>
                            <h1>This is Busqueda Articulo Page</h1>
                        </Col>
                    </Row>
...
export default BusquedaArticulo